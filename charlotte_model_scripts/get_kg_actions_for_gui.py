...
# (5) GUI-safe version of KG action execution
# instead of calling input() directly, this file reads results passed in from the Streamlit/Falcon interactive flow
...
class KGActionStore():
	...
	def reassess_symptoms(self, cm_medical_info, symptoms_list=['Chest pain', 'Short of breath']):
		print(symptoms_list, cm_medical_info.interactive_result)
		response = []
		if (self.input_type == 'synthetic') or (self.input_type == 'interactive'):
