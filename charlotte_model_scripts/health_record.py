...
# (8) state container for one crew member medical scenario 
# defines the MedicalInformation object 
# stroes the simulated crew member's EHR, elapsed time, seen actions, seen stages, and probable diagnoses
