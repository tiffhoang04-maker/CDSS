...
def get_stage_response_interactive(current_model, input_type, ehr_token, new_stage = 'Initial Assessment Stage', user_input = {}):	
	...
	#
	cm_medical_info, action_store = load_medical_info_and_action_store(current_model, input_type, ehr_token, user_input)	
...
def load_medical_info_and_action_store(current_model, input_type, ehr_token, user_input):
