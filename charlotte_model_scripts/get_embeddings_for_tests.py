...
# (7) creates local vector search indexes for matching LLM text to known KG terms. 
# builds and loads FAISS vector databases using sentence-transformer embeddings 
# maps free-text LLM responses to valid options like action names, diseases, symptoms, stages, and medications
